const color = [
  ...
  ["Aqua", "水绿色", "#D4F2E7", "rgb(212,242,231)"],
  ...
  ["Auqamarin", "绿玉碧绿色", "#7FFFAA", "rgb(127,255,170)"],
  ...
  ["LightSalmon", "浅鲜肉(鲑鱼色)", "#FFA07A", "rgb(255,160,122)"],
  ["Coral", "珊瑚", "#FF7F50", "rgb(255,127,80)"],
  ["OrangeRed", "橙红色", "#FF4500", "rgb(255,69,0)"],
  ["DarkSalmon", "深鲜肉(鲑鱼色)", "#E9967A", "rgb(233,150,122)"],
