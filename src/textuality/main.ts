...
import { OcPromise } from "../OcPromise/OcPromise";
...
function createImage(src: string): OcPromise<HTMLImageElement, any> {
...
function createVideo(src: string): OcPromise<HTMLVideoElement, any> {
  return new OcPromise((resolve, reject) => {
